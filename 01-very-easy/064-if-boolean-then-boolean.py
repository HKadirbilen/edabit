...
if __name__ == '__main__':
    ...
    Test.assert_equals(is_even(3), False)
    Test.assert_equals(is_even(10), True)
    Test.assert_equals(is_even(31), False)
    Test.assert_equals(is_even(666), True)
    Test.assert_equals(is_even(777), False)
    Test.assert_equals(is_even(3482034), True)
    Test.assert_equals(is_even(3482035), False)