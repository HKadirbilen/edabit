...
if __name__ == '__main__':
    Test.assert_equals(check_equals([1, 2], [1, 3]), False)
    Test.assert_equals(check_equals([1, 2], [1, 2]), True)
    Test.assert_equals(check_equals([4, 5, 6], [4, 5, 6]), True)
    Test.assert_equals(check_equals([4, 7, 6], [4, 5, 6]), False)
